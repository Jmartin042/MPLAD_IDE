...
Initial
		...
		MOVLF  B'11111011',TMR0H ;ADDED by AC
        MOVLF  B'00101100',TMR0L ;ADDED by AC
		MOVLF  B'00000011',ALIVECNT ;ADDED by AC
return
...
BlinkAlive
        ...
        bnz  BAend
        MOVLF  3,ALIVECNT     ;Reinitialize BLNKCNT
		bsf  PORTA,RA4        
BAend
         return
